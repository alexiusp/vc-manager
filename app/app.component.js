System.register(['angular2/core', 'angular2/router', 'angular2/http', './http.hack', './storage/storage.service', './request/request.service', './account/account.service', './account/account.component', './account/profile.component', './core/core.service', './corps/corporation.service', './corps/corporations.component', './corps/corporation.detail.component', './corps/company.component', './messages/alert.list.component', './messages/messages.service', './market/market.component'], function(exports_1, context_1) {
    ...
    var core_1, router_1, http_1, http_hack_1, storage_service_1, request_service_1, account_service_1, account_component_1, profile_component_1, core_service_1, corporation_service_1, corporations_component_1, corporation_detail_component_1, company_component_1, alert_list_component_1, messages_service_1, market_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
